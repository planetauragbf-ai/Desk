...
insert into public.tasks (objective_id, title, description, status, priority, due_date, workflow_group)
select obj.id, t.title, t.description, t.status, t.priority, t.due_date, t.phase
from obj,
(values
  ('Envoyer la documentation à GL Events',
   ...
   'termine', 'moyenne', date '2026-07-30', '1. Lancement'),
  ('Confirmer le nombre d''événements',
   ...
   'a_faire', 'moyenne', date '2026-08-07', '1. Lancement'),
  ('Confirmer l''adresse consignee auprès de KUNG',
   ...
   'a_faire', 'haute', date '2026-08-07', '1. Lancement'),
  ('Obtenir la liste des participants',
   ...
   'a_faire', 'moyenne', date '2026-08-31', '1. Lancement'),
  ('Diffuser les documents aux domaines',
   ...
   'a_faire', 'moyenne', date '2026-09-05', '2. Collecte'),
  ('Collecter et relancer les packing lists',
   ...
   'a_faire', 'moyenne', date '2026-09-26', '2. Collecte'),
  ('Contrôler la conformité des packing lists',
   ...
   'a_faire', 'moyenne', date '2026-09-29', '2. Collecte'),
  ...
  ('Pointer les réceptions à Castres',
   ...
   'a_faire', 'moyenne', null, '2. Collecte'),
  ('Relance finale des retardataires',
   ...
   'a_faire', 'moyenne', date '2026-09-28', '3. Consolidation'),
  ('DEADLINE réception des échantillons',
   ...
   'a_faire', 'critique', date '2026-10-02', '3. Consolidation'),
  ('Vérifier le marquage SAMPLE + labels caisses',
   ...
   'a_faire', 'moyenne', date '2026-10-05', '3. Consolidation'),
  ('Consolider la palette et mesurer',
   ...
   'a_faire', 'moyenne', date '2026-10-06', '3. Consolidation'),
  ('Booker le fret aérien vers ICN',
   ...
   'a_faire', 'haute', date '2026-10-06', '3. Consolidation'),
  ('Compléter le CIPL global + Shipping Mark',
   ...
   'a_faire', 'moyenne', date '2026-10-07', '3. Consolidation'),
  ...
  ('Communiquer les infos vol à KUNG',
   ...
   'a_faire', 'moyenne', date '2026-10-12', '4. Expédition'),
  ('Suivre l''acheminement jusqu''à ICN',
   ...
   'a_faire', 'moyenne', date '2026-10-20', '4. Expédition'),
  ('Confirmer dédouanement et livraison venue',
   ...
   'a_faire', 'moyenne', date '2026-11-03', '4. Expédition'),
...
) as t(title, description, status, priority, due_date, phase);
