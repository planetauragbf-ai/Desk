...
function seed(): Db {
  ...
  const db: Db = {
    ...
    tasks: [
      { id: uid(), objective_id: obj.site, title: 'Rédiger le cahier des charges du site', description: '', status: 'termine', priority: 'haute', due_date: day(-7), assignee_id: users.lea, workflow_group: null, estimated_hours: 8, spent_hours: 10, created_at: iso(-20), completed_at: iso(-8) },
      { id: uid(), objective_id: obj.site, title: "Choisir l'hébergement et le nom de domaine", description: '', status: 'en_cours', priority: 'moyenne', due_date: day(5), assignee_id: users.admin, workflow_group: null, estimated_hours: 3, spent_hours: 1, created_at: iso(-15), completed_at: null },
      { id: uid(), objective_id: obj.site, title: 'Créer la maquette des pages principales', description: '', status: 'a_faire', priority: 'haute', due_date: day(15), assignee_id: users.lea, workflow_group: null, estimated_hours: 12, spent_hours: null, created_at: iso(-10), completed_at: null },
      { id: uid(), objective_id: obj.site, title: 'Rédiger les contenus des pages', description: '', status: 'a_faire', priority: 'moyenne', due_date: day(25), assignee_id: users.sofia, workflow_group: null, estimated_hours: 10, spent_hours: null, created_at: iso(-10), completed_at: null },
      { id: uid(), objective_id: obj.event, title: 'Définir la date et le lieu', description: '', status: 'en_cours', priority: 'critique', due_date: day(7), assignee_id: users.marco, workflow_group: 'Cadrage', estimated_hours: 4, spent_hours: 2, created_at: iso(-9), completed_at: null },
      { id: uid(), objective_id: obj.event, title: 'Établir le budget prévisionnel', description: '', status: 'a_faire', priority: 'haute', due_date: day(14), assignee_id: users.marco, workflow_group: 'Cadrage', estimated_hours: 6, spent_hours: null, created_at: iso(-9), completed_at: null },
      { id: uid(), objective_id: obj.event, title: "Constituer l'équipe organisatrice", description: '', status: 'validation', priority: 'moyenne', due_date: day(3), assignee_id: users.admin, workflow_group: 'Cadrage', estimated_hours: 2, spent_hours: 2, created_at: iso(-8), completed_at: null },
      { id: uid(), objective_id: obj.communaute, title: 'Planifier le calendrier éditorial du mois', description: '', status: 'en_cours', priority: 'moyenne', due_date: day(-2), assignee_id: users.lea, workflow_group: null, estimated_hours: 3, spent_hours: 3, created_at: iso(-12), completed_at: null },
