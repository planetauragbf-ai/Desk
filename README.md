...
```
supabase/
  migrations/                # schéma + RLS (0001 → 0019 : init, accès, branding, tâches, validation, chat & liens,
  ...
  scripts/rattrapage.sql   # mise à niveau d'une base déjà en service
